...
### Added
- Place ID search tool directly in settings — type a business name and click a result to fill in the Place ID. Works for online businesses, service-area businesses, and any business without a precise map pin. Uses the `findplacefromtext` API endpoint.
